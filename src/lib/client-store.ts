...
export function useClients() {
  ...
  return useMemo(() => ({
    ...
    updateClientMeta(id: string, updates: { name?: string; category_id?: string; dashboard_type?: DashboardType; funil_fonte_topo?: 'auto' | 'crm' | 'anuncios'; fidelidade_ativa?: boolean }) {

...
// Corpo da antiga página /integracoes — agora renderizado como aba de Configurações.
// A rota /integracoes virou redirect (preservando query do OAuth); subrotas
// /integracoes/clickup e /integracoes/leadlovers continuam páginas próprias.

...
- **Cron 3x/dia**: workflow roda às 06h, 12h e 18h BRT (09/15/21 UTC). A tela lê snapshot do banco (não é tempo real) — os 3 horários mantêm o dado fresco; "Atualizar todos"/refresh por linha força na hora.

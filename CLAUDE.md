...
- **Cron 3x/dia**: workflow roda às **09h15**, 12h e 18h BRT (12h15/15/21 UTC). A 1ª batida (09h15) é de propósito a que **dispara o aviso do dia** (a trava por data faz o aviso sair só na 1ª coleta) — mudar o horário do aviso = mudar a 1ª linha do cron. A tela lê snapshot do banco (não é tempo real); os 3 horários mantêm o dado fresco; "Atualizar todos"/refresh por linha força na hora. ⚠️ GitHub Actions não é preciso no minuto (atrasa alguns min, às vezes throttdla — ver nota sistêmica); pra horário exato, migrar pra crontab da VPS.
